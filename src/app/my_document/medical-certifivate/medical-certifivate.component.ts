...
@Component({
  selector: 'app-medical-certifivate',
  templateUrl: './medical-certifivate.component.html',
  styleUrls: ['./medical-certifivate.component.css']
})
export class MedicalCertifivateComponent implements OnInit {
  public name = 'Pipat'
